...
func TestSegment_AddCid_noLocalAddrKeep(t *testing.T) {
	result := segments.TestSegment("addcid", map[string]string{"filename": "../../../examples/enricher/subnet_ids.csv"},
...
func TestSegment_AddCid_bothAddrs(t *testing.T) {
	result := segments.TestSegment("addcid", map[string]string{"matchboth": "1", "filename": "../../../examples/enricher/subnet_ids.csv"},
